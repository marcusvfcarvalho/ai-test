...
public class CitiesControllerTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    private static City CreateSampleCity(string name = "São Paulo", string state = "SP", string country = "Brazil", int population = 12325232)
    {
        new City
        {
            Name = name,
    ...
    public async Task UpdateCity_ReturnsUpdatedCity()
    {
        ...
        Assert.Equal("São Paulo Updated", result.Name);
